...
function ChatLIstItem({data, isContactPage = false}) {
  ...
  return (
    <div className={`flex cursor-pointer items-center hover:bg-backgound-default-hover`} onClick={handleContactClick}>
  ...
  <div>
      ...
      <div className="flex border-b border-conversation-border pb-2 pt-1 p3-2">
        <div className="flex justify-between w-full">
          <span className="text-secondary lone-clamp-1 text-sm">
            {data?.about || "\u00A0"}
          </span>
        </div>
      </div>
