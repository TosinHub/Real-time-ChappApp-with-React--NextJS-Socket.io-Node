...
function ChatHeader() {
  const [{currentChatUser : user}] = useStateProvider()


  return <div className="h-16 px-4 py-3 flex justify-between items-center bg-panel-header-backgound 0z-1">
    ...
    <div className="flex item-center justify-center gap-6">
      ...
      <div className="flex flex-col">
        ...
        <span className="text-secondary text-sm">{user?.about}</span>
      </div>
    </div>
